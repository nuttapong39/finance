...
$html = '
	...
	<table border="0" style="width:950px;">
		...
		<tr>
			<td colspan="5"><span style="font-size:15pt;">&nbsp;</span></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="230">&nbsp;</td>
			<td width="130" rowspan="2" valign="top"><span style="font-size:10pt;">'.$PayTo.'<br>***'.number_format($Sumnet, 2) . "\n".'***</span></td>
			<td width="100">&nbsp;</td>
			<td width="515" colspan="2"></td>
		</tr>
		<tr>
			<td width="150"><span style="font-size:10pt;">&nbsp;</span></td>
			<td width="60">&nbsp;</td>
			<td width="515" colspan="2"></span></td>
		...
		<tr>
			...
			<td width="130"></td>
			<td width="100">&nbsp;</td>
			<td width="455" align="right"><span style="font-size:15pt;"><b>***'.number_format($Sumnet, 2) . "\n".'***</b></span></td>
