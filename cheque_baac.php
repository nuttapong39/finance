...
$html = '
	...
	<table border="0" style="width:900px;">
		...
		<tr>
			...
			<td width="100">&nbsp;</td>
			<td width="515" colspan="2">&nbsp;&nbsp;<span style="font-size:16pt;"><b>-'.$PayTo.'-</b></span></td>

		</tr>
		<tr>
			<td width="40">&nbsp;</td>
			<td width="100">&nbsp;</td>
			<td width="520" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:16pt;"><b>('.$Sumnettext.')</b></span></td>
		</tr>
		<tr>
			<td width="40">&nbsp;</td>
			<td width="130"><span style="font-size:10pt;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;***'.number_format($Sumnet, 2) . "\n".'***</span></td>
			<td width="100">&nbsp;</td>
			<td width="420" align="right"><span style="font-size:16pt;"><b>***'.number_format($Sumnet, 2) . "\n".'***</b></span></td>
			<td width="113.385"></td>
		</tr>
	</table>
	<br>
