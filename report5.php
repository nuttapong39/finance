...
if($PlanPay!=""){
  $sql1 = "SELECT *,sum(Amount) as AmountAll FROM payment where DateIn between '$DateStart' and '$DateEnd' and PlanPayId='$PlanPay' and Source='$Source' and DatePaid NOT BETWEEN '$DateStart' and '$DateEnd'";
  $sql = "SELECT *,sum(Amount) as Amounts FROM payment where DateIn between '$DateStart' and '$DateEnd' and PlanPayId='$PlanPay' and Source='$Source' and DatePaid NOT BETWEEN '$DateStart' and '$DateEnd' group by PlanPayId";

}else{
  $sql1 = "SELECT *,sum(Amount) as AmountAll FROM payment where DateIn between '$DateStart' and '$DateEnd' and Source='$Source' and DatePaid NOT BETWEEN '$DateStart' and '$DateEnd'";
  $sql = "SELECT *,sum(Amount) as Amounts FROM payment where DateIn between '$DateStart' and '$DateEnd' and Source='$Source' and DatePaid NOT BETWEEN '$DateStart' and '$DateEnd' group by PlanPayId";
}
...
$strExcelFileName="export_payable_".$Datereport.".xls";
...
<body>
<strong>รายงานเจ้าหนี้การค้า <?php echo $Sourcetext.' '.$OfficeName;?><br>(ระหว่างวันที่ <?php echo DateThai($DateStart);?> ถึงวันที่ <?php echo DateThai($DateEnd);?>)</strong>
<div id="SiXhEaD_Excel" align=center x:publishsource="Excel">
<table class='table table-striped' border="1">
      <tr>
        <td width="100" align="center"><b>ลำดับ</b></td>
        <td width="400"><b>ค่าใช้จ่าย (รหัสรายการ/ชื่อเจ้าหนี้การค้า)</b></td>
...
if ($result->num_rows > 0) {
  $nums=$result->num_rows;
    ...
    $data3= "";
    $sql3 = "SELECT * FROM payment where DateIn between '$DateStart' and '$DateEnd'  and Source='$Source' and DatePaid NOT BETWEEN '$DateStart' and '$DateEnd' and PlanPayId='$PlanPayId'";
        ...
        $CompanyName=$rowtc['CompanyName'];
          ...
          $data3.= "
            <tr>
              ...
              <td width='400'>"."&nbsp; - ".$PayId."/".$CompanyName."</td>
              <td width='200' align='right'>".number_format($Amount, 2) . "\n"."</td>
          ...
          <table border='1' style='width:900px'>
            <tr>
              ...
              <td width='400'>".$PlanPayName."</span></td>
              <td width='200' align='right'>".number_format($Amounts, 2) . "\n"."</td>
              <td width='200'></td>
            </tr>".$data3."
            </table>";
    $i++;
...
?>
    <tr>
      <td width="500" colspan="2" align="right"><b>เจ้าหนี้คงเหลือ</b></td>
